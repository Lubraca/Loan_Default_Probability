...
class LoanApplicationRawInput(BaseModel):
    ...
    SELIC_LAG1: Optional[float] = None
    SELIC_CHANGE: Optional[float] = None
    SELIC_ROLLING_MEAN3: Optional[float] = None
    IPCA_LAG1: Optional[float] = None
    IPCA_CHANGE: Optional[float] = None
    IPCA_ROLLING_MEAN3: Optional[float] = None
